  ...
  t.behaviors.alertSignupForm = {
    attach: function(a, i) {
      function n() {
        ...
        var s = {};
        t.settings.doca_common.alertHideName || (s.cu_FULL_NAME = e("#cu_FULL_NAME").val()), t.settings.doca_common.alertHideNumber || (s.cu_CONTACT_NUMBER = e("#cu_CONTACT_NUMBER").val()), s.cu_DEPARTMENT_ID = e("#cu_DEPARTMENT_ID").val();
        var o = t.settings.doca_common.alertMailGroup.split(","),
        ...
        e.getJSON(r + "/scripts/subscribe/subscribe.php?callback=?", {
          ...
          switch (e(i).hide(), n.code) {
            case "000":
              e(a).addClass("messages--status").html(t.settings.doca_common.alertSuccessMessage);
              break;
            case "101":
            case "102":
            case "103":
      ...
      e(".alert-signup__formm").submit(function() {
        return n(), !1
      })
    }
  }
    ...
    attach: function() {
      try {
        ...
        a.length > 0 && e(a).each(function() {
          e(this).val(t.settings.doca_common.formalSubmissionNotify)
        })
      }
      catch (i) {}
    }
