    ...
    <?php if (!empty($alert_priority)): ?>
      <div class="alert-priority <?php print strtolower(trim('alert-priority-' . $alert_priority)); ?>">
        <div class="alert-list__icon">
          <svg version="1.1" id="alert" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
               x="0px" y="0px" viewBox="0 0 44.8 27.9" preserveAspectRatio="xMidYMid meet"
               enable-background="new 0 0 44.8 27.9" xml:space="preserve"><g>
